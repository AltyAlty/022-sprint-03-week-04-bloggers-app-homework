...
/*Input DTO для query-параметров при получении постов по ID блога.*/
export type GetPostListByBlogIdQueryInputDTO = DefaultPaginationSettingsType<PostSortFieldQueryInputDTO>;
